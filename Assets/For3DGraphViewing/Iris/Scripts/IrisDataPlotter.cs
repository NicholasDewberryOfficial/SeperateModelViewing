...
//
public class IrisDataPlotter : MonoBehaviour
{
   ...
   // public NPCConversation NPCConversation;
    ...
    //WARNING: USUALLY SET TO 10
     private float plotScale = 20;
	...
	private void PlacePrefabPoints()
	{
                ...
                for (var i = 0; i < pointList.Count; i++)
        {
            ...
            bc.isTrigger = true;
           IrisDataHolder iHolder = dataPoint.AddComponent<IrisDataHolder>();
           iHolder.ID = System.Convert.ToSingle(pointList[i][xColumnName]);
           iHolder.sepalLength = System.Convert.ToSingle(pointList[i][yColumnName]);
           iHolder.sepalWidth = System.Convert.ToSingle(pointList[i][zColumnName]);
